...
namespace Tests01
{
    ...
    public class UnitTests
    {
        ...
        {
            var problems = new Problems();
            Assert.AreEqual(1147483646, problems.Median("147483644, 147483645, 1147483646, 1147483647, 2147483647"));
        }
        ...
        {
            var problems = new Problems();
            Assert.AreEqual(5, problems.Median("0, 2, some, 4, 6, 8, 10, word"));
        }
    }
}
