...
namespace Tests01
{
    ...
    public class UnitTests
    {
        ...
        {
            var problems = new Problems();
            Assert.AreEqual(5, problems.Median("21, 13, 8, 5, 3, 1, 1"));
        }
        ...
        {
            var problems = new Problems();
            Assert.AreEqual(50, problems.Median("100, 51, 50, 0, 1"));
        }
        ...
        {
            var problems = new Problems();
            Assert.AreEqual(1147483646, problems.Median("147483644, 147483645, 1147483646, 1147483647, 2147483648"));
        }
        ...
        {
            var problems = new Problems();
            Assert.AreEqual(1147483647, problems.Median("47483642, 147483644, 47483643, 1147483647, 2147483648, 2147483649, 147483645, 1147483646"));
        }
        ...
        {
            var problems = new Problems();
            Assert.AreEqual(6, problems.Median("0, 2, some, 4, 6, 8, 10, word"));
        }
    }
}
